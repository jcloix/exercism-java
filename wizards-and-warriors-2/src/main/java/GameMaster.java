public class GameMaster {
    ...
    public String describe(TravelMethod travelMethod) {
        return String.format("You're traveling to your destination %s.",
                travelMethod.getShortName());
    }

    public String describe(Character character, Destination destination, TravelMethod travelMethod) {
        return describe(character).concat(" ").concat(describe(travelMethod)).concat(" ").concat(describe(destination))exercism download --track=java --exercise=change;
    }
